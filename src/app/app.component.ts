...
import {OneInchApiService} from './services/intrxn.api/intrxn.api.service';
...
import {Quote, SwapData} from './services/intrxn.api/intrxn.api.dto';
    ...
    public onTokenChange(): void {
        ...
        this.tokenService.tokenHelper$.pipe(
            tap((tokenHelper) => {
                ...
                console.log(this.fromAmountBN, this.fromAmount)
